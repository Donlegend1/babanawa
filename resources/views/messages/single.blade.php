																																...
																																<div class="row">
																																				...
																																				<div class="mail_message col-lg-12">
																																								...
																																								<div class="reply_btn pull-right mb-mob-3 mt-5">
																																												...
																																												@if ($message->created_by !== Auth::user()->id && $message->message_status_id == 0)
																																																<div class="reply_btn pull-left">
																																																				<button class="btn btn-primary mb-mob-3" data-toggle="modal"
																																								...
																																								<div class="modal fade" id="delegateModal" tabindex="-1" role="dialog"
																																												aria-labelledby="delegateModalLabel" aria-hidden="true">
																																												<div class="modal-dialog">
																																																<div class="modal-content">
																																																				<div class="modal-header">
																																																												...
																																																												<div class="card-body">
																																																																...
																																																																<div class="form-group">
																																																																				...
																																																																				<input class="form-control form-control-lg"
																																																																								...
																																																																								id="example-text-input-lg" value="">
																																																																</div>
