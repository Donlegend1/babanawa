                                    ...
                                    <div class="col-sm-6">
                                        <div class="sales-info"><span class="sales-info-box bg-primary mr-2"></span>
                                            <div class="sales-info-body">
                                                <h6>Income</h6><small><span class="text-primary"><i class="feather ft-chevron-up"></i> 17%</span> this month</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="sales-info"><span class="sales-info-box bg-warning mr-2"></span>
                                            <div class="sales-info-body">
