<div class="row">
			...
			<div class="card-body marpadd">
                ...
                @enderror
					...
					<div class="col-md-offset-2 text-right">
						@if ($currentStep > 1)
							<button wire:click="previousStep" class="btn btn-primary buttonxx"> <span class="fa fa-arrow-left"></span>
								Back</button>
						@endif
				...
				@if ($currentStep == 2 && $resultType === 2)
								...
								<div class="card-body">
									...
									<div class="form-group col-md-12 aligncenter">
										...
										<div class="form-group col-md-6 col-sm-6">
											...
											<input wire:model="jsceresult" type="file" accept=".png, .jpg, .jpeg" class="form-control"
					...
					<div class="col-md-offset-2 mt-10 text-right">
						...
						@if ($jsceresult)
							<button wire:click="nextStep" class="btn btn-primary buttonxx"> <span class="fa fa-arrow-right"></span>
								Proceed</button>
						@endif
					</div>
				...
				@if ($currentStep === 3)
					...
					<div class="main-content-inner">
												...
												<div class="col-md-12">
													...
													<div class="media-left">
														<a href="#" class="profile-image">
															...
															@if ($passport)
																<img class="user-img img-radius" src="{{ $passport->temporaryUrl() }}" alt="user-img"
																	style=" width:200px height:200px">
															@else
																<img class="user-img img-radius" src="../../images/ava.png" alt="user-img">
															@endif
													...
													<div class="avatar-edit">
														...
														<div class="form-group col-md-6 col-sm-6">
															<input type="file" name="image" id="file" class="inputfile" wire:model="passport"
																accept=".png, .jpg, .jpeg" />
																...
																<div class="col-lg-12 col-xl-6">
																	<div class="table-responsive">
																		<table class="m-0 table">
																			<tbody>
																				<tr>
																					<th scope="row" class="mainfield">Full Name
																					</th>
																					<td class="capitalz">
																						{{ $surname }}
																						{{ $firstname }}
																				...
																				<tr>
																					<th scope="row" class="mainfield">Gender</th>
																					<td class="capitalz">
																						{{ $gender }}</td>
																				</tr>
																				<tr>
																					<th scope="row" class="mainfield">Birth Date
																					</th>
																					<td class="capitalz">
																						{{ $dob }}</td>
																				</tr>
																...
																<div class="col-lg-12 col-xl-6">
																	<div class="table-responsive">
																		<table class="table">
																			<tbody>
																				<tr>
																					<th scope="row" class="mainfield">Email</th>
																					<td class="capitalz"><a href="#!">{{ $email }}</a>
																					</td>
																				</tr>
																				<tr>
																					<th scope="row" class="mainfield">Mobile Number
																					</th>
																					<td class="capitalz">
																						{{ $phone }}</td>
																				</tr>
																				<tr>
																					<th scope="row" class="mainfield">State</th>
																					<td class="capitalz">
																						{{ $dis_state->name }}</td>
																				</tr>
																				{{--  <tr>
										...
										<div class="col-lg-4 col-sm-12 mt-mob-4">
											...
											<div class="image_card">
												...
												@if ($jsceresult)
													<div class="card_img" style="background-image: url('{{ $jsceresult->temporaryUrl() }}')"></div>
													<a href="#" class="card_link">
														<div class="card_img_hover_sec" style="background-image: url('{{ $jsceresult->temporaryUrl() }}')">
														</div>
													</a>
												@endif
                        ...
                        <input type="hidden" name="" value="{{$stream}}" wire:model="stream">
                        <input type="hidden" name="" value="{{$type}}" wire:model="type">
					...
					<div class="col-md-offset-2 text-right">
						...
						onclick="payWithPaystack()">Proceed</button> --}}
							...
							<button onclick="checkImageAndProceed()" class="btn btn-success buttonxx">
								Proceed</button>
						@endif
					</div>
				@endif
	...
	<div>
		...
		<div>
			...
			<script>
				// Function to handle the Paystack integration
				...
				// Function to check if an image is chosen and proceed accordingly
				function checkImageAndProceed() {
				...
				// Attach an event listener to the button for proceeding
				// document.getElementById('proceedButton').addEventListener('click', checkImageAndProceed);
			</script>
			{{-- @endif --}}
		</div>
	</div>
